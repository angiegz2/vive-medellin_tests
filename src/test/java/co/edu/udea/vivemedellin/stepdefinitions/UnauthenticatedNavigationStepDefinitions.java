...
public class UnauthenticatedNavigationStepDefinitions {
    ...
    public void theUserIsNotAuthenticated() {
        // Context only – no login is performed
    }
    ...
    public void theUserViewsTheInitialListOfEvents() {
        // The list is visible once the home page has loaded
    }
    ...
    visitor.attemptsTo(
            // Verify that the search input for events is visible in the home page
